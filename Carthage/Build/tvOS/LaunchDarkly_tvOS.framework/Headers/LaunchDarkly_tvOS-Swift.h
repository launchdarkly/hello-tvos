...
/// This operation is not thread safe. You may want to use a DispatchQueue if calling <code>identify</code> from multiple threads.
/// \param user The ObjcLDUser set with the desired user.
///
